...
class VerifyOTPController extends GenericReqRes {
    constructor() {
    ...
    async create(req, res) {
        try {
            const result = await OTPService.verifyOTP(req.body.phoneNumber, req.body.otpCode, req.body.otpSent, req.user.userID);
